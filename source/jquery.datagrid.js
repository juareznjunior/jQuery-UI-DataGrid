...
;(function($,window,document,undefined) {
	...
	var jQueryDataGrid = {
		options : {
			...
			/**
			 * default jquery.ui css framework
			 * option: 'bs' bootstrap
			 * @type {String}
			 */
			,cssFw: 'ui'
		...
		,_create: function() {
			...
			// container datagrid
			this.uiDataGrid = $(getTemplateDataGrid(this.options.cssFw));
		...
		,_message: function(m) {
			...
			$('<tr><td class="ui-widget ui-datagrid-align-center ui-state-error" colspan="1000">'+m+'</td></tr>')
				.appendTo(this.uiDataGridTbody.empty()[0]);
		}
		,_ajax: function() {
