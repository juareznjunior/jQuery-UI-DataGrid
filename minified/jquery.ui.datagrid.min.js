...
this.render()},_setOption:function(a,c){"jsonStore"===a&&b.isPlainObject(c)?this.options.jsonStore=b.extend({},this.options.jsonStore,c):b.Widget.prototype._setOption.apply(this,arguments)},_createPageButtons:function(){var a=this,c=b(a.uiDataGridTfoot[0].rows[0].cells).last()[0];a.uiDataGridTdPagination.td=c;a.uiDataGridTdPagination.childs.push(b(c).children()[0]);b.map(["first","prev","next","end"],function(d,e){e=b("<button>").attr("name","data-grid-button-"+d).text(d).button({icons:{primary:"ui-icon-seek-"+
d},text:!1,disabled:!0}).appendTo(c);a.uiDataGridTdPagination.childs.push(e[0])});b(c).on("click","button.ui-button",function(a){return function(c){c.preventDefault();!1===this.disabled&&(c=["_",this.name.replace(/data-grid-button-/,""),"Page"],b(a.uiDataGridTdPagination.childs).filter("button").removeClass("ui-state-hover ui-state-focus").button("disable"),a[c.join("")](),a.load());return!1}}(a));c=a=null},_managePagination:function(a){var c=this,d,e;c.options.pagination&&a&&(c._totalPages=Math.ceil(a/
c.options.limit),d=0==c._offset?1:c._offset/c.options.limit+1,e=d+" de "+c._totalPages+" ("+a+")",this.uiDataGridTdPagination.td.style.visibility="visible",b.each(this.uiDataGridTdPagination.childs,function(){/span/i.test(this.tagName)?this.innerHTML=e:/data-grid-button-(first|prev)/.test(this.name)?0<c._offset&&this.disabled&&b(this).button("enable"):c._totalPages>d&&this.disabled&&b(this).button("enable")}));c=null},_createColumns:function(){var a=this,c,d=[],e='<div class="ui-widget ui-state-default" style="overflow:scroll;position:absolute;left:0"></div>',
...
dataType:"json",context:this,success:function(a){if(i!=a.error||0===a.length){b.isFunction(this.options.onError)?this.options.onError.call(this.element[0]):alert(0===this.length?"Empty rows":this.error);return false}this._createRows(a,"ajax")}}))},render:function(){var a=this,c,d;a._active()?(a.resetOffset(),a.load()):(b.isArray(a.options.toolBarButtons)&&(c=a.uiDataGridTfoot[0].rows[0].cells[0],b.map(a.options.toolBarButtons,function(d){(function(a){if(b.isFunction(d.fn))this.on("click",function(c){c.preventDefault();
d.fn.apply(a.element[0],arguments);b(this).blur();return!1});this.button({icons:{primary:i===d.icon?null:"ui-icon-"+d.icon}});c.appendChild(this[0])}).call(b("<button>").text(d.label),a)}),c=null),"none"===a.element.css("display")&&a.element.show(),a.uiDataGrid.appendTo(a.element),a._createColumns(),d=a.uiDataGridThead.outerHeight(),a.uiDataGridTheadBody.parent().css("marginTop",-d),d=null,a.resize(),a.options.autoLoad&&a.load(),b.isFunction(a.options.onComplete)&&setTimeout(function(a){a.options.onComplete.call(a.element[0])},
1,a));a=null;return this},_nextPage:function(){this._offset+=this.options.limit},_prevPage:function(){this._offset-=this.options.limit},_endPage:function(){this._offset=this._totalPages*this.options.limit-this.options.limit},_firstPage:function(){this._offset=0},_tbodyEvents:function(){if(b.isFunction(this.options.onClickRow))this.uiDataGridTbody.off().on("click","tr",function(a){return function(c){b(this).addClass("ui-state-highlight");a.options.onClickRow.call(a.element[0],this);var d=a.uiDataGridTbody[0],
e=b.data(d,"rowselected");c.currentTarget!==e[0]&&e.removeClass("ui-state-highlight");b.data(d,"rowselected",b(c.currentTarget))}}(this));return this},_active:function(){return this.element.children(":eq(0)").hasClass("ui-datagrid-container")},_getBHF:function(a,c){return b.isFunction(c)?c.call(a[0]):a},resize:function(){this.options.fit&&function(a){a=a.uiDataGrid.outerHeight()-a.element.height();this.style.height=b(this).height()-a+"px"}.call(this.uiDataGridScrollBody[0],this.element[0]);return this},
getSelectedRow:function(){return b.data(this.uiDataGridTbody[0],"rowselected")},clearSelectedRow:function(){(function(){b.data(this,"rowselected").removeClass("ui-state-highlight");b.data(this,"rowselected",b([]))}).call(this.uiDataGridTbody[0])},load:function(){this._ajax();return this},widget:function(){return this.uiDataGrid},destroy:function(){b.Widget.prototype.destroy.call(this);this.element.empty()},getOffset:function(){return this._offset},resetOffset:function(){this._offset=0},getThead:function(a){return this._getBHF(this.uiDataGridThead,
a)},getTbody:function(a){return this._getBHF(this.uiDataGridTbody,a)},getTFoot:function(a){return this._getBHF(this.uiDataGridTfoot,a)}})})(jQuery,window,document);