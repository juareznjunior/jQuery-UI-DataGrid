...
f=null,j=0,h=0,g="<col></col>",k='<th class="ui-widget ui-state-default" role="columnheader"></th>';c.map(a.options.mapper,function(a){f=a.title||a.name;j=10;b=c(k).html(f);b=b.text(b.text());/left|right|center/.test(a.align)&&(b[0].style.textAlign=a.align);i!==a.width&&(j=a.width);d[d.length]=c(g).width(j)[0];e[e.length]=b[0];h+=j});a.options.rowNumber&&(d.splice(0,0,c(g).width(20)[0]),e.splice(0,0,c('<th class="ui-state-default ui-datagrid-cell-rownumber" role="columnheader"><div></div></th>')[0]),
h+=20);h>a.element.width()&&a.uiDataGridScrollMain.width(h);c([a.uiDataGridColGroup1[0],a.uiDataGridColGroup2[0]]).append(d.slice(0,-1));c([a.uiDataGridThead[0].rows[0],a.uiDataGridTheadBody[0].rows[0]]).append(e);c(a.uiDataGridThead[0].rows[0].cells).slice(0,-1).map(function(b,d){d=c(this).outerWidth();a.uiDataGridColGroup1.children().eq(b).width(d);a.uiDataGridColGroup2.children().eq(b).width(d)});c(a.uiDataGridTbody[0].parentNode).map(function(a,b){c(b).clone().appendTo(b.parentNode).find("tbody").append('<tr><td class="ui-state-default ui-datagrid-cell-rownumber">&nbsp;'+
Array(b.tHead.rows[0].cells.length).join('</td><td class="ui-widget ui-widget-content">&nbsp;')+"</td></tr>").prev().hide()});e=b=a=g=d=k=null},_createRows:function(a,b,e){var d=this,f=d.getThead()[0].rows[0].cells,j=e?d.uiDataGridTbody[0]:d.uiDataGridTbody.empty()[0],h,g,k=e?j.rows.length+1:d._offset+1,l="local"===b&&d.options.pagination,b=i===a.num_rows?i===a.rows?i===a[0].num_rows?a.length:a[0].num_rows:i===a.rows[0].num_rows?a.rows.length:a.rows[0].num_rows:a.num_rows,a=a.rows||a;!e&&(l&&1<k)&&
(a=a.slice(d._offset));e||(d._managePagination(b),d.uiDataGridScrollBody.scrollTop(0));c.each(a,function(a,b){if(!e&&l&&a===d.options.limit)return!1;h=j.insertRow(-1);h.className="ui-state-hover";d.options.rowNumber&&(g=h.insertCell(0),g.className="ui-state-default ui-datagrid-cell-rownumber",g.innerHTML="<div>"+(k+a)+"</div>");c.map(d.options.mapper,function(a){g=h.insertCell(-1);g.className="ui-widget ui-widget-content";g.style.cssText="text-align:"+f[g.cellIndex].style.textAlign;c(g).html(c.isFunction(a.render)?
a.render.call(g,b[a.name],b):b[a.name])})});f=j=h=g=d=a=null},_ajax:function(){var a=this.options,b=a.jsonStore.url,e=a.limit,d=this._offset,f=a.jsonStore;i===b||""===b?(b=(f.data.rows||f.data)[0],i===b||i===b[a.mapper[0].name]?alert("Invalid JSON"):this._createRows(f.data,"local"),b=null):("string"===typeof f.params?f.params=0===d?f.params+"&limit="+e+"&offset="+d:f.params.replace(/(&offset=)(.+)/,"&offset="+d):(i===f.params&&(f.params={}),f.params.limit=e,f.params.offset=d),c.ajax({type:a.ajaxMethod.toLowerCase(),
url:b.replace(/\?.*/,""),data:f.params,dataType:"json",context:this,success:function(a){if(i!=a.error||0===a.length)return c.isFunction(this.options.onError)?this.options.onError.call(this.element[0]):alert(0===this.length?"Empty rows":this.error),!1;this._createRows(a,"ajax")}}))},render:function(){var a=this,b,e=0;if(a._active())a.resetOffset(),a.load();else{c.isArray(a.options.toolBarButtons)&&(b=a.uiDataGridTfoot[0].rows[0].cells[0],c.map(a.options.toolBarButtons,function(d){(function(a){if(c.isFunction(d.fn))this.on("click",
function(b){b.preventDefault();d.fn.apply(a.element[0],arguments);c(this).blur();return!1});this.button({icons:{primary:i===d.icon?null:"ui-icon-"+d.icon}});b.appendChild(this[0])}).call(c("<button>").text(d.label),a)}),b=null);"none"===a.element.css("display")&&a.element.show();a.uiDataGrid.appendTo(a.element);a._createColumns();a.uiDataGridTheadBody.hide();a.resize();if(a.options.autoLoad){var e=180,d=a;setTimeout(function(){d.load()},e)}if(c.isFunction(a.options.onComplete)){var f=a;setTimeout(function(){f.options.onComplete.call(f.element[0])},
e+1)}}a=null;return this},_nextPage:function(){this._offset+=this.options.limit},_prevPage:function(){this._offset-=this.options.limit},_endPage:function(){this._offset=this._totalPages*this.options.limit-this.options.limit},_firstPage:function(){this._offset=0},_tbodyEvents:function(){if(c.isFunction(this.options.onClickRow))this.uiDataGridTbody.off().on("click","tr",function(a){return function(b){c(this).addClass("ui-state-highlight");a.options.onClickRow.call(a.element[0],this,b);var e=a.uiDataGridTbody[0],
d=c.data(e,"rowselected");b.currentTarget!==d[0]&&d.removeClass("ui-state-highlight");c.data(e,"rowselected",c(b.currentTarget))}}(this));return this},_active:function(){return this.element.children(":eq(0)").hasClass("ui-datagrid-container")},_getBHF:function(a,b){return c.isFunction(b)?b.call(a[0]):a},resize:function(){this.options.fit&&function(a){a=a.uiDataGrid.outerHeight()-a.element.height();this.style.height=c(this).height()-a+"px"}.call(this.uiDataGridScrollBody[0],this);return this},getSelectedRow:function(){return c.data(this.uiDataGridTbody[0],
